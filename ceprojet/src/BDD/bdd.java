...
public class bdd {
    ...
    public static String dbname="ceprojet";
    ...
    public void chekuserandpass(String username, String password) {
    ...
    public boolean chekuserandpass(String username, String password) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
